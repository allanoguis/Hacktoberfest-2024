    ...
    <footer className="bg-black text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h2 className="text-xl font-semibold text-indigo-400">Open Source Contribution</h2>
            <p className="mt-2 text-gray-400">
              This is an open-source project. Contributions are welcome! Check out the GitHub repository for more information.
            </p>
            <div className="mt-4 flex items-center space-x-4">
              ...
              <button
                onClick={() => window.open('https://github.com/allanoguis/Hacktoberfest-2024/issues')}
          ...
          <div>
            <h2 className="text-xl font-semibold text-indigo-400">Subscribe for Game Updates</h2>
            <form className="mt-4">
              <input
                type="email"
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center">
          <p className="text-gray-400">© 2024 Gojirun. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
